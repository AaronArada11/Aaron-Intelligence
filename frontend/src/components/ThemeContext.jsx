...
const flavors = {
  nimbus: {
    ...
    blue: "#1e66f5", lavender: "#7287fd", amber: "#ffb000", crimson: "#dc143c",
  },
  sage: {
    ...
    blue: "#8caaee", lavender: "#babbf1", amber: "#ffb000", crimson: "#dc143c",
  },
  neptune: {
    base: "#0B1F33", mantle: "#021526", crust: "#010D19",
    ...
    blue: "#89b4fa", lavender: "#b4befe", amber: "#ffb000", crimson: "#dc143c",
  },
  abyss: {
    ...
    blue: "#8aadf4", lavender: "#b7bdf8", amber: "#ffb000", crimson: "#dc143c",
  },
};

const accentList = [
  "rosewater","flamingo","pink","mauve","red","maroon",
  "peach","yellow","green","teal","sky","sapphire","blue","lavender", "amber", "crimson"
];
